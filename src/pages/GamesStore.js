...
class GamesStore extends React.Component {
  ...
  getByCategory = () => {
    axios
      .get(
        "https://difficult-girdle-fly.cyclic.app/admin/getBy-category/" +
          this.state.gameCategory
      )
      .then((res) => {
        this.setState({ data: res.data.data });
      })
  ...
  searchName = () => {
    axios
      .get(
        "https://difficult-girdle-fly.cyclic.app/admin/getByName/" +
          this.state.gameName
      )
      .then((res) => {
        this.setState({ data: res.data.data });
  ...
  render() {
    return (
      <div class="container-xxl fixed "  style={{ color: '#0a4275', marginTop:"110px"}}>
        <div>
