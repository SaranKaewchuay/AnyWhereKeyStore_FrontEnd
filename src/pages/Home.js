                            ...
                            <div className="recommend-slide__box">
                              <div className="recommend-slide__info">
                                ...
                                <div className="recommend-slide__intro">
                                  <span>
                                    Ultimate Horizon Adventure is waiting for
                                    you!
                                  </span>
                                </div>
                                <div className="recommend-slide__rating-and-price">
                                  ...
                                  <div className="recommend-slide__price">
                                    <span>฿ 1899</span>
                                  </div>
                                </div>
                              ...
                              >
                                <div className="recommend-slide__img">
                                  <img src="https://shorturl.asia/vJ4cu" />
                                </div>
                              </Link>
                              <div className="recommend-slide__favorites">
                          ...
                          <div className="recommend-slide">
                            <div className="recommend-slide__box">
                              <div className="recommend-slide__info">
                                ...
                                <div className="recommend-slide__intro">
                                  <span>
                                    Ghostrunner offers a unique single-player
                                    experience: fast-paced and violent combat.
                                  </span>
                                </div>
                                <div className="recommend-slide__rating-and-price">
                                  <div className="recommend-slide__rating">
                              ...
                              >
                                <div className="recommend-slide__img">
                                  <img src="https://shorturl.asia/Zuktn" />
                                </div>
                              </Link>
                              <div className="recommend-slide__favorites">
                                <i className="ico_favourites"></i>
                          ...
                          <div className="recommend-slide">
                            <div className="recommend-slide__box">
                              <div className="recommend-slide__info">
                                ...
                                <div className="recommend-slide__intro">
                                  <span>
                                    Dark Souls continues to push the boundaries
                                    with the latest
                                  </span>
                                </div>
                                <div className="recommend-slide__rating-and-price">
                              ...
                              >
                                <div className="recommend-slide__img">
                                  <img src="https://shorturl.asia/23Z7g" />
                                </div>
                              </Link>
                              <div className="recommend-slide__favorites">
                                <i className="ico_favourites"></i>
                          ...
                          <div className="recommend-slide">
                            <div className="recommend-slide__box">
                              <div className="recommend-slide__info">
                                ...
                                <div className="recommend-slide__intro">
                                  <span>
                                    Experience Aloy's legendary quest to unravel
                                    the mysteries of a future world ruled by
                                    machines.
                                  </span>
                                </div>
                                <div className="recommend-slide__rating-and-price">
                              ...
                              >
                                <div className="recommend-slide__img">
                                  <img src="https://shorturl.asia/UQvgu" />
                                </div>
                              </Link>
                              <div className="recommend-slide__favorites">
                                <i className="ico_favourites"></i>
                            ...
                            <div className="game-card__box">
                              <div className="game-card__media">
                                <Link
                                  ...
                                  style={{ textDecoration: "none" }}
                                >
                                  <img src="https://shorturl.asia/IaGxq" />
                                </Link>
                              </div>
                              <Link
                                to={"/game-profile/" + 16}
                              ...
                              >
                                <div className="game-card__info">
                                  ...
                                  <div className="game-card__genre">
                                    On the shores of a mysterious island, You
                                    must learn to survive. Use your cunning to
                                    kill or control primitive creatures roaming
                                    the land.{" "}
                                  </div>
                        ...
                        <div className="swiper-slide">
                          <div className="game-card --horizontal">
                            ...
                            >
                              <div className="game-card__box">
                                <div className="game-card__media">
                                  <img src="https://shorturl.asia/ut8jA" />
                                </div>
                                <div className="game-card__info">
                                  Days Gone
                                  <div className="game-card__genre">
                                    Fight in post-pandemic America. Play as
                                    Deacon St. John, a Drifter and bounty hunter
                                    who rides on crumbling roads.
                                  </div>
                                  <div className="game-card__rating-and-price">
                                    <div className="game-card__rating">
                                      <span>4.5</span>
                                  ...
                                  <div className="game-card__bottom">
                                    <div className="game-card__platform">
                                      <i>
                                        <img
                                          src="https://icons.iconarchive.com/icons/martz90/circle-addon2/24/playstation-icon.png"
                                          class="mb-1"
                                        />
                                      </i>
                                      <i>
                                        <img
                                          src="https://icons.iconarchive.com/icons/martz90/circle-addon1/24/xbox-icon.png"
                                          class="mb-1"
                                        />
                                      </i>
                                      <i>
                                        <img
                                          src="https://icons.iconarchive.com/icons/martz90/circle/24/windows-8-icon.png"
                                          class="mb-1"
                                        />
                                      </i>
                                      <i>
                                        <img
                                          src="https://icons.iconarchive.com/icons/uiconstock/socialmedia/32/Apple-icon.png"
                                          class="mb-1"
                                        />
                                      </i>
                                    </div>
                          ...
                          <div className="swiper-slide">
                            <div className="game-card">
                              ...
                              >
                                <div className="game-card__box">
                                  <div className="game-card__media">
                                    <img src="https://shorturl.asia/DcdEh" />
                                  </div>
                                  <div className="game-card__info">
                                    Planet Zoo
                                    <div className="game-card__genre">
                          ...
                          <div className="swiper-slide">
                            <div className="game-card">
                              ...
                              >
                                <div className="game-card__box">
                                  <div className="game-card__media">
                                    <img src="https://shorturl.asia/Sbv6O" />
                                  </div>
                                  <div className="game-card__info">
                          ...
                          <div className="swiper-slide">
                            <div className="game-card">
                              ...
                              >
                                <div className="game-card__box">
                                  <div className="game-card__media">
                                    <img src="https://shorturl.asia/wCL4i" />
                                  </div>
                                  <div className="game-card__info">
                                    Fallout 4
                                    <div className="game-card__genre">
                          ...
                          <div className="swiper-slide">
                            <div className="game-card">
                              ...
                              >
                                <div className="game-card__box">
                                  <div className="game-card__media">
                                    <img src="https://shorturl.asia/NYokt" />
                                  </div>
                                  <div className="game-card__info">
                                    Titanfall® 2
                                    <div className="game-card__genre">
